...
#need distance to transect, size of burrow, if the burrow was detected, what transect (for Rdistance), 
#the veg information at that burrow and the occupancy of the burrow 
